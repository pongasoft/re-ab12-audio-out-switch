...
function switchTapFunction(singleStateStep, output)
  return function(props, di, gi, cd) return handleSwitchTap(props, singleStateStep, output) end
end
...
function handleSwitchTap(props, singleStateStep, output)
  local changes = {}
  local uiText = ""
